...
void Mesh::Draw(vec2 pos, ShaderProgram* pShader, Texture* pTexture, vec2 UVScale, vec2 UVOffset, vec2 ObjectScale)
{
    ...
    // Setup our uniforms.
    {
        ...
        SetUniform2f( pShader, "u_ObjectScale", ObjectScale);
